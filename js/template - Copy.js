      ...
      function adTemplate(advertiser) {
        ...
        return `
                ...
                <div class="row  shadow-lg m-5 py-2  bg-white"> 
                        <div class=" row  py-2   ">  
                        <div class="col-lg-4 ">
                            <img src="images/${advertiser.image}.jpg" class="img-fluid rounded m-3" alt=" ${advertiser.Headline} with ${advertiser.Advertiser}">
                        </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light navbar-collapse ">
                    ...
                    <a href="#" class="btn btn-outline-light text-dark " target="_blank" rel="noopener noreferrer" onclick="shareOnFacebook()">
                        <i class="fab fa-facebook-f"></i> 
                    </a>
                    <a href="#" class="btn btn-outline-light text-dark" target="_blank" rel="noopener noreferrer" onclick="shareOnTwitter()">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="#" class="btn btn-outline-light text-dark" onclick="shareViaEmail()">
